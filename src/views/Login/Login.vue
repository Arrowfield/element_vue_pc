<template>
    <div class="login">
        ...
        <div class="login-panel">
            ...
            <fl-avatar src="https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png"
                       :size="100"></fl-avatar>
    ...
    export default {
        ...
        methods: {
            async login() {
                ...
                let res = await loginApi({uname: this.userName, upwd: this.password}).catch((err) => {
                    if (err) if (err) return false
                })
